function(instance, context) {
    ...
    var randomElementID =
        ...
        instance.data.cardTitleCollapseRows = 1;
    ...
    instance.data.addQuillEditor = (editor) => {
        ...
        instance.data.logging ? console.log("Toolbar selected Succesfully " + toolbar): null;
        quill.getModule('toolbar').container.style.display = 'none';
        quill.root.parentElement.style.borderTop = `1px`;
        // set min height to 65px
        quill.root.style.minHeight = '65px';
        //remove top padding
    ...
    new */
        ...
        quill.root.addEventListener('focus', (e) => {
            ...
            toolbar.parentElement.style.paddingTop = "16px";
    ...
    instance.data.deleteFoldCollapse = () => {
        ...
        waitForElm('.expandEditor').then((elm) => {
            ...
            instance.canvas.find('.expandEditor').click(function () {
                ...
                // console.log(`the div`, elm);
                // //set the parent containers margin to 0
                // window.getComputedStyle(elm.parentElement).marginBottom === '0px' ? elm.parentElement.style.marginBottom = "16px" : elm.parentElement.style.marginBottom = "0px";
